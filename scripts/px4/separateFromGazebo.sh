...
# cp PX4-Autopilot/Tools/simulation/gazebo-classic/sitl_run.sh PX4-Autopilot/Tools/simulation/gazebo-classic/sitl_run.sh.bak
...
/home/user/workspace/gazebo/GazeboDrone
