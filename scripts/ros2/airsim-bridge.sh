...
CheckDirExists ros2/airsim
CheckDirEmpty ros2/airsim

CheckDirExists ros2/airsim/install
CheckFileExists ros2/airsim/install/setup.bash

source /opt/ros/${ROS_DISTRO}/setup.bash
source ros2/airsim/install/setup.bash
